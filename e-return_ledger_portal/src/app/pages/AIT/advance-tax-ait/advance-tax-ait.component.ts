...
@Component({
  selector: 'app-advance-tax-ait',
  templateUrl: './advance-tax-ait.component.html',
  styleUrls: ['./advance-tax-ait.component.scss']
})
export class AdvanceTaxAitComponent implements OnInit {
  ...
  typeTooltip=`<span class="btn-block well-sm";">Select the instrument through which advance tax was paid.</span>`;
  taxesZoneTooltip = `<span class="btn-block well-sm";">Select the tax zone relevant to the circle.</span>`;
  taxesCircleTooltip = `<span class="btn-block well-sm";">Select the circle in which favor the advance tax was paid.</span>`;
  resetBtnTooltip = `<span class="btn-block well-sm";">Use RESET button for another AIT instalment or for a new entry.</span>`;
