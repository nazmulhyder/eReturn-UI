...
@Component({
  selector: 'app-offline-return-view865',
  templateUrl: './offline-return-view865.component.html',
  styleUrls: ['./offline-return-view865.component.css']
})
export class OfflineReturnView865Component implements OnInit {
