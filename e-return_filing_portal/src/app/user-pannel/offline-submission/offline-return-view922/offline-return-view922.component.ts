...
@Component({
  selector: 'app-offline-return-view922',
  templateUrl: './offline-return-view922.component.html',
  styleUrls: ['./offline-return-view922.component.css']
})
export class OfflineReturnView922Component implements OnInit {
