...
@Component({
  selector: 'app-offline-single-return-view',
  templateUrl: './offline-single-return-view.component.html',
  styleUrls: ['./offline-single-return-view.component.css']
})
export class OfflineSingleReturnViewComponent implements OnInit {
  ...
  getUserReturnData() {
    ...
    this.apiService.post(this.serviceUrl + 'api/get-basic-return-info', getUserReturnDataRequestBody)
      .subscribe(result => {
        if (result != null) {
