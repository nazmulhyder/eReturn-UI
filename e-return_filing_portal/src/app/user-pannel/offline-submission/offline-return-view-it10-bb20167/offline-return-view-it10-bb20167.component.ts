...
@Component({
  selector: 'app-offline-return-view-it10-bb20167',
  templateUrl: './offline-return-view-it10-bb20167.component.html',
  styleUrls: ['./offline-return-view-it10-bb20167.component.css']
})
export class OfflineReturnViewIT10BB20167Component implements OnInit {
