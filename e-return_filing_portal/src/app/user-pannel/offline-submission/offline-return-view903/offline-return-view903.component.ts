...
@Component({
  selector: 'app-offline-return-view903',
  templateUrl: './offline-return-view903.component.html',
  styleUrls: ['./offline-return-view903.component.css']
})
export class OfflineReturnView903Component implements OnInit {
