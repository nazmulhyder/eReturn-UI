...
@Component({
  selector: 'app-offline-return-view846',
  templateUrl: './offline-return-view846.component.html',
  styleUrls: ['./offline-return-view846.component.css']
})
export class OfflineReturnView846Component implements OnInit {
