...
@Component({
  selector: 'app-post-return-view-it10-bb20167',
  templateUrl: './post-return-view-it10-bb20167.component.html',
  styleUrls: ['./post-return-view-it10-bb20167.component.css']
})
export class PostReturnViewIt10Bb20167Component implements OnInit {
  userTin: any;
  taxPayerName: any;
  ...
  getTaxpayerBasicInfo() {
    ...
    this.ending_income_yr = this.basicInfo.endOfIncomeYr;
