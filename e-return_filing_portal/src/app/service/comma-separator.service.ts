...
export class CommaSeparatorService {
  ...
  extractComma(userInput: any) {
    return userInput ? String(userInput).replace(/,/g, '') : "";
  }
...
removeCommaExpenditure(userInput:any, dpoint:any) {
  ...
  currencySeparatorBD(nStr:any)
  {
      ...
      else if(nStr== null || nStr==='' || isNaN(nStr)) return "";
      else return new Intl.NumberFormat('en-IN').format(parseFloat(nStr));
  }
}
