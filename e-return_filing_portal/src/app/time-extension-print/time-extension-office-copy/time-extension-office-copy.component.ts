...
@Component({
  selector: 'app-time-extension-office-copy',
  templateUrl: './time-extension-office-copy.component.html',
  styleUrls: ['./time-extension-office-copy.component.css']
})
export class TimeExtensionOfficeCopyComponent implements OnInit {
