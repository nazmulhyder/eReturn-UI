...
@Component({
  selector: 'app-return-view884',
  templateUrl: './return-view884.component.html',
  styleUrls: ['./return-view884.component.css']
})
export class ReturnView884Component implements OnInit {
  ...
  getBusinessDataFromExemptedIncome()
  {
    ...
    this.apiService.post(this.serviceUrl + 'api/management/return-view/get-tax-exempted-income', reqObj)
      .subscribe(result => {
