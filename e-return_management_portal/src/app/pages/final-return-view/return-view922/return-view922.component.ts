...
@Component({
  selector: 'app-return-view922',
  templateUrl: './return-view922.component.html',
  styleUrls: ['./return-view922.component.css']
})
export class ReturnView922Component implements OnInit {
  ...
  salaryReturnGetData(){
    this.apiService.get(this.serviceUrl + 'api/management/return-view/salaries/' + this.userTin + '/2021-2022/')
      .subscribe(result => {
