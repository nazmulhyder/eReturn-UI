...
@Component({
  selector: 'app-return-view941',
  templateUrl: './return-view941.component.html',
  styleUrls: ['./return-view941.component.css']
})
export class ReturnView941Component implements OnInit {
  ...
  getEledgerSummary(): Promise<void> {
    return new Promise((resolve, reject) => {
      this.apiService.get(this.serviceUrl + 'api/management/return-view/tds_summary/' + this.userTin + '/' + '2021-2022')
        .subscribe(result => {
  ...
  getTotalRegularPayment(): Promise<void> {
    ...
    return new Promise((resolve, reject) => {
      this.apiService.post(this.serviceUrl + 'api/management/return-view/get_client_payment_summary', requestData)
        .subscribe(result => {
          if (JSON.stringify(result.replyMessage) != '{}') {
    ...
    this.apiService.post(this.serviceUrl + 'api/management/return-view/get-basic-return-info', reqBody)
      .subscribe(result => {
        ...
        if (JSON.stringify(result.replyMessage) != '{}') {
          ...
          //day
          this.dd1 = this.submissionDate.substring(0, 1);
          this.dd2 = this.submissionDate.substring(1, 2);
          //month
          this.mm1 = this.submissionDate.substring(3, 4);
          this.mm2 = this.submissionDate.substring(4, 5);
          //year
          this.yy1 = this.submissionDate.substring(6, 7);
          this.yy2 = this.submissionDate.substring(7, 8);
          this.yy3 = this.submissionDate.substring(8, 9);
          this.yy4 = this.submissionDate.substring(9, 10);
