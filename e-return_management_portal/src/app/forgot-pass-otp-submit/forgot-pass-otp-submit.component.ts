...
@Component({
  selector: 'app-forgot-pass-otp-submit',
  templateUrl: './forgot-pass-otp-submit.component.html',
  styleUrls: ['./forgot-pass-otp-submit.component.scss']
})
export class ForgotPassOtpSubmitComponent implements OnInit {
  ...
  onSubmit() {
      ...
      this.otpVerifyRequest.userIdentification = localStorage.getItem('userId');
      this.otpVerifyRequest.feature = "RESET_PASSWORD_MANAGEMENT";
      this.otpVerifyRequest.userType = "MANAGEMENT";
    ...
    this.apiService.post(this.serviceUrl + 'api/auth/verify-otp', this.otpVerifyRequest)
      .subscribe(result => {
        ...
        this.router.navigate(["/auth/forgot-reset-password"]);
